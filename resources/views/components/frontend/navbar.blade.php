          ...
          <div class="w-auto">
            ...
            >
              <li class="mx-3 py-6 md:py-0">
                <a href="#" class="{{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}text-black  hover:underline"
                  >Showcase</a
                >
              </li>
              <li class="mx-3 py-6 md:py-0">
              ...
              @auth
                  <li class="mx-3 py-6 md:py-0">
                    <a href="{{ route('dashboard.index') }}" class=" {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}text-black  hover:underline"
                      >Dashboard</a
                    >
                  </li>
              @endauth
              @guest
                  <li class="mx-3 py-6 md:py-0">
                    <a href="{{ route('login') }}" class=" {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}text-black  hover:underline"
                      >Login</a
                    >
                  </li>
                  <li class="mx-3 py-6 md:py-0">
                    <a href="{{ route('register') }}" class="{{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }}text-black  hover:underline"
                      >Register</a
                    >
                  </li>
              @endguest

        ...
        <div class="flex -mx-4 flex-row relative">
          ...
          @foreach($produks as $produk)
            <div class="px-4 relative card group">
              ...
              <h5 class="text-lg font-semibold mt-4">{{ $produk->namaproduk }}</h5>
              <span class="">IDR {{ number_format($produk->hargaproduk) }}</span>
              <a href="{{ route('details', $produk->slug) }}" class="stretched-link">
                <!-- fake children -->
              </a>
            </div>
          @endforeach
